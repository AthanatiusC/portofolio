...
@Component({
  selector: 'app-essentialskill',
  templateUrl: './essentialskill.component.html',
  styleUrls: ['./essentialskill.component.css']
})
export class EssentialskillComponent implements OnInit {
